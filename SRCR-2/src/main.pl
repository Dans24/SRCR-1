...
excecao(utente(IdUt,Nome,Idade, Morada)) :- utente(IdUt, ListaDeNome, ListaDeIdade, ListaDeMorada),
                                            ou(contem(Nome, ListaDeNome), nulo(ListaDeNome), verdadeiro),
                                            ou(contem(Idade, ListaDeIdade),nulo(ListaDeIdade), verdadeiro),
                                            ou(contem(Morada, ListaDeMorada), nulo(ListaDeMorada), verdadeiro).
...
excecao(prestador(IdPrest, Nome, Especialidade, Instituicao)) :- prestador(IdPrest, ListaDeNome, ListaDeEspecialidade, ListaDeInstituicao),
                                                                 ou(contem(Nome, ListaDeNome),nulo(ListaDeNome),verdadeiro),
                                                                 ou(contem(Especialidade, ListaDeEspecialidade),nulo(ListaDeEspecialidade),verdadeiro),
                                                                 ou(contem(Instituicao, ListaDeInstituicao),nulo(ListaDeInstituicao),verdadeiro).
...
excecao(cuidado(IdCuid, Data, IdUt, IdPrest, Descricao, Custo)) :- cuidado(IdCuid, ListaDeData, ListaDeIdUt, ListaDeIdPrest, ListaDeDescricao, ListaDeCusto),
                                            ou(contem(Data, ListaDeData), nulo(ListaDeData), verdadeiro),
                                            ou(contem(IdUt, ListaDeIdUt),nulo(ListaDeIdUt), verdadeiro),
                                            ou(contem(IdPrest, ListaDeIdPrest), nulo(ListaDePrest), verdadeiro),
                                            ou(contem(Descricao, ListaDeDescricao), nulo(ListaDeDescricao), verdadeiro),
                                            ou(contem(Custo, ListaDeCusto), nulo(ListaDeCus), verdadeiro).
...
%% Remoção do Sistema --------------------------------
utente(2,[dan,mig],[12,20],braga).

test(1):- addUtente(2,[dan,mig],[12,20],braga).
